  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
            ...
            <tbody>
              {[
                ...
                <tr key={step} className="border-b border-gray-100 last:border-0">
                  ...
                  <td className="px-4 py-3 text-gray-600">{breath}</td>
                  <td className="hidden px-4 py-3 text-gray-500 sm:table-cell">{mistake}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="mb-10">
        ...
        <div className="space-y-0 rounded-xl border border-gray-200 bg-white divide-y divide-gray-100">
          {[
            {
